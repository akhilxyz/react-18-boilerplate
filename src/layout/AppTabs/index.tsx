...
const operateList = [
  { id: 1, title: 'refresh current', icon: 'icon-[bi--arrow-repeat]' },
  { id: 2, title: 'Close current', icon: 'icon-[bi--x-lg]' },
  { id: 3, title: 'Close other', icon: 'icon-[bi--x-lg]' },
  { id: 4, title: 'close left', icon: 'icon-[bi--arrow-left-circle]' },
  { id: 5, title: 'close right', icon: 'icon-[bi--arrow-right-circle]' },
  { id: 6, title: 'Close all', icon: 'icon-[bi--x-lg]' },
]
